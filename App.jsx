...
import ViewCustomer from './ViewCustomer'; // Make sure the component name starts with a capital letter
import Slider from './Slider'; // Make sure the component name starts with a capital letter
import Overview from './Overview'; // Make sure the component name starts with a capital letter
...
<div className='main-container' style={{marginLeft:"-24px"}} id="mainCot">
  ...
  <div className='frame-3'>
    ...
    <div className='frame-82'>
      <div className='frame-83'>
        ...
        <div className='div-8a'>
          <button className='button'>
            <span className='span-8b'>Booked</span>
          </button>
        </div>
